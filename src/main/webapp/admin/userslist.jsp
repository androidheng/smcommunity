    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '密码', width: 400, field: 'password',sortable: true},
                {title: '性别', width: 400, field: 'gender',sortable: true},
                {title: '昵称', width: 400, field: 'nickname',sortable: true},
                {title: '邮箱', width: 400, field: 'email',sortable: true},
