...
<head id="Head1">
    ...
    var _menus = "";
    	_menus = {
      	         "menus": [
				{"menuid": "1", "icon": "icon-magic", "menuname": "商品信息管理",
			          "menus": [
			              {"menuid": "12", "menuname": "商品列表", "icon": "icon-database", "url": "<%= basePath%>seller/goodslist.jsp"}
        			  ]} ,
      	
      	             {"menuid": "56", "icon": "icon-role", "menuname": "发布商品广告",
      	                 "menus": [
      	                     {"menuid": "31", "menuname": "商品广告列表", "icon": "icon-users", "url": "<%= basePath%>seller/goodslist2.jsp"}
      	                 ]
